...
class ICMyInfo extends Component {
    ...
    render() {
        return ( <
            ...
            <
            label htmlFor = "exampleInputPassword1" > 帳號 < /label> { /* <input type="email" value={this.state.IC_email} name="IC_email" onChange={this.change} className="form-control" /> */ } <
            input type = "email"
            name = "IC_email"
            value = {
                this.state.IC_email
            ...
            <
            div > { /* <button type="submit" className="btn btn-primary">修改密碼</button> */ } <
            /div>
            ...
            div className = "" >
            <
            div className = "case_successAlert alert alert-success"
            role = "alert" > 修改成功! < /div> <
            button type = "submit"
            onClick = {
                this.sent
            }
            className = "save_button member_button" > 儲存 < /button>
